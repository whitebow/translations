function showThisCal(idToShow, hide1, hide2, hide3) {
		...
		function scoreCalculatorCal() {
			...
			if (!data.procs[cpu] || data.procs[cpu][ramc][rams] == "") {
				...
				alert("Selected GPU does not support SLI/CrossFire!")
			} else {
		...
		function addSaveButton(target,id) {
			...
			var text = document.createTextNode('Save this')
			button.append(text)
	...
	"CaseFan": {
		...
		"Fractal Design Silent Series LL White 120mm": {
			...
			"partName": "Silent Series LL White 120mm",
			"price": 15,
			"sellPrice": 5,
			"level": 26,
			"airflow": 41.8,
		...
		"Fractal Design Silent Series LL Red 120mm": {
			...
			"manufacturer": "Fractal Design",
			"partName": "Silent Series LL Red 120mm",
			"price": 15,
			"sellPrice": 5,
			"level": 26,
			"airflow": 41.8,
		...
		"Fractal Design Silent Series LL Blue 120mm": {
			...
			"manufacturer": "Fractal Design",
			"partName": "Silent Series LL Blue 120mm",
			"price": 15,
			"sellPrice": 5,
			"level": 26,
			"airflow": 41.8,
		...
		"Thermaltake Riing Plus 12 LED RGB": {
			...
			"partName": "Riing Plus 12 LED RGB",
			"price": 20,
			"sellPrice": 7,
			"level": 28,
			"airflow": 48.34,
		...
		"Fractal Design Dynamic X2 GP-12 (Black)": {
			...
			"manufacturer": "Fractal Design",
			"partName": "Dynamic X2 GP-12 (Black)",
			"price": 13,
			"sellPrice": 4,
			"level": 21,
			"airflow": 52,
		...
		"Thermaltake Riing Plus 14 LED RGB": {
			...
			"manufacturer": "Thermaltake",
			"partName": "Riing Plus 14 LED RGB",
			"price": 25,
			"sellPrice": 8,
			"level": 28,
			"airflow": 63.19,
		...
		"Fractal Design Dynamic X2 GP-14 (Black)": {
			...
			"manufacturer": "Fractal Design",
			"partName": "Dynamic X2 GP-14 (Black)",
			"price": 15,
			"sellPrice": 5,
			"level": 21,
			"airflow": 68,
		...
		"EKWB EK-Vardar EVO 120ER RGB": {
			...
			"manufacturer": "EKWB",
			"partName": "EK-Vardar EVO 120ER RGB",
			"price": 30,
			"sellPrice": 10,
			"level": 25,
			"airflow": 77,
		...
		"EKWB EK-Vardar EVO 140S BB": {
			...
			"manufacturer": "EKWB",
			"partName": "EK-Vardar EVO 140S BB",
			"price": 30,
			"sellPrice": 10,
			"level": 25,
			"airflow": 98,
